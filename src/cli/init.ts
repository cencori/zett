...
const AVAILABLE_TOOLS: ToolEntry[] = [
  ...
  { id: "transcribe_audio", label: "transcribe_audio", description: "Transcribe audio files to text (ElevenLabs Scribe, or Cencori whisper-1 fallback)", files: ["agent/tools/transcribe_audio.ts"] },
  { id: "text_to_speech", label: "text_to_speech", description: "Synthesize speech from text (ElevenLabs, or Cencori tts-1 fallback)", files: ["agent/tools/text_to_speech.ts"] },
